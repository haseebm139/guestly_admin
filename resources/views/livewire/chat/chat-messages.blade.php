    ...
    <div class="card" id="kt_chat_messenger">
                        ...
                        <div class="d-flex justify-content-end mb-10">
                            <div class="d-flex flex-column align-items-end">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="me-3">
                                        <span class="text-muted fs-7 mb-1">{{ \Carbon\Carbon::createFromTimestamp($msg['timestamp'])->diffForHumans() }}</span>
                                        <a href="#"
        ...
        @if ($selectedUser)
            <div class="card-footer pt-4" id="kt_chat_messenger_footer">
                <textarea wire:model.live="message" wire:keydown.enter.prevent="sendMessage" class="form-control form-control-flush mb-3" rows="1"
