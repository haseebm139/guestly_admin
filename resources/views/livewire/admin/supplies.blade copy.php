<div>
    ...
    <table class="table align-middle table-row-dashed">
        ...
        <tr class="text-muted fw-bold">
            <th>Name</th><th>Description</th><th class="text-end">Action</th>
        </tr>
        </thead>
        <tbody>
        @forelse ($supplies as $s)
            <tr>
                ...
                <td>{{ $s->description }}</td>
                <td class="text-end">
                    <button class="btn btn-icon btn-hover-primary"
        ...
        @empty
            <tr><td colspan="3" class="text-center py-10">No supplies found.</td></tr>
        @endforelse
        </tbody>
    </table>
