...
<head>
    ...
    <style>
        body {
            ...
            transition: opacity 0.8s ease; /* Smooth fade-in for initial page load */
        }
        @font-face {
        ...
        .label_phone {
            position: absolute;
            left: 410px;
            top: 56%; /* input ke bilkul neeche */
            color: red;
            font-size: 12px;
            margin-top: 2px; /* thoda gap */
            width: 100%;
            text-align: center;
            pointer-events: none;
        }
        ...
        .helper-text { font-size: 13px; color: #333333; text-align: center; line-height: 1.4; margin: -5px 0 10px; font-family: 'Actor', sans-serif; }
        .forgot-password { text-align: right; margin-top: -10px; margin-bottom: 15px; }
        .forgot-password a { color: #014122; font-size: 13px; text-decoration: none; font-weight: 500; }
        .forgot-password a:hover { text-decoration: underline; }
        .continue-btn { width: 100%; padding: 18px; background: #014122; color: white; border: none; border-radius: 50px; font-size: 16px; font-weight: 500; cursor: pointer; font-family: 'Arial Rounded MT Bold', sans-serif; }
        .divider { display: flex; align-items: center; text-align: center; color: #333333; font-family: 'Arial Rounded MT Bold', sans-serif; margin: 20px 0; font-size: 12px; }
        .divider::before, .divider::after { content: ''; flex: 1; border-bottom: 1px solid #D3D3D3; }
        .divider:not(:empty)::before { margin-right: 2.5em; }
        .divider:not(:empty)::after { margin-left: 2.5em; }
        .social-btn { display: flex; align-items: center; justify-content: center; gap: 10px; width: 100%; padding: 12px; border: 1px solid #0b3d27; border-radius: 50px; background-color: #E5F8F2; color: #32423b; font-size: 14px; font-weight: 500; margin-bottom: 10px; cursor: pointer; font-family: 'Arial Rounded MT Bold', sans-serif; }
        ...
        .toggle-form-text { text-align: center; margin-top: 20px; font-size: 14px; color: #333; }
        .toggle-form-text a { color: #014122; font-weight: 500; text-decoration: none; cursor: pointer; }
        ...
        label.error {
            ...
            margin-top: auto;
            display: block;
            width: 100%;       /* label ka width input ke barabar */
...
<div class="container">
    ...
    <div class="right">
        ...
        <div id="login-form-container">
            ...
            <form id="loginForm" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="login-password" name="password" placeholder="{{ __('enter_password') }}" required>
            ...
            <button class="social-btn"><img src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg" alt="Google"> {{ __('Continue_with_google') }}</button>
            <button class="social-btn"><img src="https://upload.wikimedia.org/wikipedia/commons/b/b8/2021_Facebook_icon.svg" alt="Facebook"> {{ __('Continue_with_facebook') }}</button>
            <button class="social-btn"><img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg" alt="Apple"> {{ __('Continue_with_apple') }}</button>
            <p class="toggle-form-text">{{ __('dont_have_account') }} <a id="show-signup-link">{{ __('signUp') }}</a></p>
        </div>
        ...
        <div id="signup-form-container" style="display: none;">
            ...
            <form id="signupForm" method="POST" action="{{ route('signup', ['role' => request('role', 'artist')]) }}">
                @csrf
                ...
                <div class="form-group">
                    <label>{{ __('password') }}</label>
                    <input type="password" id="signup-password" name="password" placeholder="{{ __('enter_password') }}">
                ...
                <div class="input-group-connected">
                    <div class="form-group">
                        ...
                        <select name="country_region">
                            <option value="" disabled selected style="color: gray;">{{ __('enter_country_region') }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone_number" placeholder="{{ __('enter_phone_number') }}">
                    </div>
                </div>
            ...
            <p class="toggle-form-text">{{ __('already_have_account') }} <a id="show-login-link">{{ __('login') }}</a></p>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        $('#signupForm').validate({
            ...
            errorPlacement: function(error, element) {
                if (element.attr("name") === "country_region" || element.attr("name") === "phone_number") {
