    ...
    <head>
        ...
        <style>
            ...
            .main-container {
                display: none;
                /* Initially hidden, JS will show the correct one */
            ...
            .coupon-input-wrapper.open {
                max-height: 100px;
                /* Should be enough for the input field */
                opacity: 1;
                margin-top: 15px;
            }
            ...
            @media (max-width: 750px) {
                #artist-plans-container .pricing-container {
                    flex-direction: column;
                    align-items: center;
                }

                #artist-plans-container .plan-card {
                    width: 100%;
                    max-width: 350px;
                }
            }
    ...
    <body>
        ...
        <div id="artist-plans-container" class="main-container">
            ...
            <div class="pricing-container">
                <div class="plan-card active" data-plan-name="Free Tier" data-price-monthly="Free"
                    data-price-yearly="Free">
                    <h3>Free Tier</h3>
                    <hr>
                    <ul class="features-list">
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> 1 active
                            studio request at a time.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Basic guest
                            artist profile.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Messaging with
                            studios (limited).</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Studio
                            calendar viewing (read-only).</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Studio seat
                            availability view.</li>
                    </ul>
                    <button class="plan-button">Free</button>
                </div>
                <div class="plan-card" data-plan-name="Pro Tier" data-price-monthly="$19.99/month"
                    data-price-yearly="$199/year">
                    <h3>Pro Tier</h3>
                    <hr>
                    <ul class="features-list">
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Unlimited
                            studio requests.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Full booking
                            management tools.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Advanced
                            guest artist profile.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Priority
                            messaging and real-time chat.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Direct
                            calendar integration.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Preferred
                            studio tagging.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> And Much More
                        </li>
                    </ul>
        ...
        <div id="studio-plans-container" class="main-container">
            ...
            <div class="billing-toggle">
                <span>{{ __('monthly_toggle') }}</span>
                <label class="switch"><input type="checkbox" class="billing-cycle-toggle"><span
            ...
            <div class="pricing-container">
                <div class="plan-card active" data-plan-name="Free Tier" data-price-monthly="Free"
                    ...
                    <hr>
                    <ul class="features-list">
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> List 1 seat.
                        </li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Basic listing
                            and visibility.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Studio
                            appears in search.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Receive
                            booking requests</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Basic
                            studio profile</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Limited
                            messaging</li>
                    </ul>
                    <button class="plan-button">Free</button>
                </div>
                <div class="plan-card" data-plan-name="Pro Tier" data-price-monthly="$19.99/month"
                    ...
                    <hr>
                    <ul class="features-list">
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> List up to
                            3 seats.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Unlimited
                            messaging with guests.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Add studio
                            amenities, branding, and multiple photos.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Access
                            guest workday scheduling tools.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Priority
                            placement in search.</li>
                    </ul>
                    <button class="plan-button">$19.99/month</button>
                </div>
                <div class="plan-card" data-plan-name="Studio Plus Tier" data-price-monthly="$49.99/month"
                    data-price-yearly="$499/year">
                    <h3>Studio Plus Tier</h3>
                    <hr>
                    <ul class="features-list">
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> List up to
                            8 seats.</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Private
                            "Studio Notes" section for internal feedback on guests</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Advanced
                            calendar controls (block dates, manage multiple stations)</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Detailed
                            analytics (views, bookings, guest history)</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Add custom
                            guest terms and per-day commission settings</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Option to
                            hide or show reviews</li>
                    </ul>
                    <button class="plan-button">$49.99/month</button>
                </div>
                <div class="plan-card" data-plan-name="Studio Unlimited" data-price-monthly="$149.99/month"
                    data-price-yearly="$1499/year">
                    <h3>Studio Unlimited</h3>
                    <hr>
                    <ul class="features-list">
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Everything
                            in Pro, plus</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Private
                            "Studio Notes" section for internal feedback on guests</li>
                        <li><img src="{{ asset('assets/web/extra/vector.png') }}" alt="tick" class="tick-icon"> Advanced
            ...
            <div class="modal-content">
                <form>
                    ...
                    <div class="payment-methods">
                        <div class="method-card active"><img
                    ...
                    <div class="form-group"><label for="card-name">Name on card</label><input type="text"
                            id="card-name" value="John doe"></div>
                    <div class="form-group"><label for="card-number">Card Number</label><input type="text"
                            id="card-number" placeholder="Enter Your Card Number"></div>
                    <div class="form-row">
                        <div class="form-group"><label for="expiry-date">Expiry Date</label><input type="text"
                                id="expiry-date" placeholder="MM/YY"></div>
                        <div class="form-group"><label for="cvc">Security Code</label><input type="text"
                    ...
                    <hr>
                    <div class="modal-footer"><span class="price">$19/month</span><button type="submit"
                            class="pay-now-btn">Pay Now</button></div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-overlay" id="success-modal">
            <div class="modal-content success-modal-content">
                ...
                <button class="start-verification-btn_artist"
                    onclick="window.location.href='user_identification'">{{ __('start_verification') }}</button>
                <button class="start-verification-btn_studio"
                    onclick="window.location.href='studio_step_form'">{{ __('start_verification') }}</button>
            </div>
        </div>
