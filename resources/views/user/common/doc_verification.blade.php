    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .progress-step.active {
            ...
            height: 5px; /* Increase height for active step */
            margin-top: -3px;
        }
        ...
        .verification-option {
            ...
            padding: 15px; border: 2px solid var(--border-inactive);
            border-radius: 8px; cursor: pointer; transition: all 0.3s ease;
        }

        .verification-option.active { border-color: #5E8082; background-color: var(--card-bg-active); }

        .icon-container {
            width: 48px; height: 48px; background-color: #f0f2f5;
            border-radius: 10px; display: flex; align-items: center; justify-content: center;
            margin-right: 15px; flex-shrink: 0;
        }

        .verification-option .icon { width: 52px; height: auto; }

        .option-text { flex-grow: 1; }
        .option-text strong { display: block; font-size: 16px; font-weight: 600; color: #333333;}
        .option-text span { font-size: 13px; color: #333333; font-family: 'Actor', sans-serif }
        .verification-option.active .option-text strong {
            color: #014122;
        }
        .checkmark {
            font-size: 24px; color: var(--primary-green); font-weight: bold;
        ...
        .verification-option .tick svg {
            width: 36px;  /* increase icon size as needed */
            height: 36px;
        }
        .verification-option.active .tick { visibility: visible; opacity: 1; }

        .upload-area {
            position: relative; border-radius: 16px; height: 220px; display: flex;
            flex-direction: column; justify-content: center; align-items: center;
            background-color: #f7faf9; border: 2px dashed var(--border-inactive);
        ...
        .nav-btn {
            flex: 1; border-radius: 50px; padding: 15px; font-size: 16px;
            font-weight: 600; cursor: pointer; transition: background-color 0.3s ease, opacity 0.3s;
            border: 2px solid transparent;
        }

        .nav-btn:disabled {
            background-color: #e9edeb; color: #a0b0ab;
            cursor: not-allowed; border-color: #e9edeb;
        }

        .back-btn {
            background-color: #5E8082; color: #eaf1f1; border-color: #e9edeb;
        }

        .back-btn:disabled { opacity: 1.5; color: #eaf1f1; background-color: #5E8082 }

        .next-btn { background-color: #014122; color: white; border-color: var(--primary-green); font-family: 'Arial Rounded MT Bold', sans-serif; font-weight: 100; }
        ...
        .modal-content {
            ...
            width: 100%; max-width: 420px; box-shadow: 0 5px 20px rgba(0,0,0,0.1);
        ...
        .success-modal-content {
            position: relative; text-align: center; padding: 30px; padding-top: 200px;
        }
        .success-icon {
        ...
        .success-modal-btn {
            ...
            border-radius: 50px; padding: 15px; width: 100%; font-size: 16px;
        ...
        <div class="form-step active" data-step="0">
            ...
            <div class="options-list">
                <div class="verification-option active" data-value="id">
                    <div class="icon-container"><img src="{{ asset ('id_card_icon.png') }}" class="icon" alt="ID Card Icon"></div>
                    <div class="option-text"><strong>{{ __('id_card_heading') }}</strong><span>{{ __('id_card_message') }}</span></div>
{{--                    <div class="checkmark">✓</div>--}}
                ...
                <div class="verification-option" data-value="passport">
                    <div class="icon-container"><img src="{{ asset ('passport_icon.png')}}" class="icon" alt="Passport Icon"></div>
                    <div class="option-text"><strong>{{ __('passport_heading') }}</strong><span>{{ __('passport_message') }}</span></div>
{{--                    <div class="checkmark">✓</div>--}}
                    <div class="tick">
                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21 7.81817L9 19.8182L3.5 14.3182L4.91 12.9082L9 16.9882L19.59 6.40817L21 7.81817Z" fill="#014122" stroke="#014122"/>
                ...
                <div class="verification-option" data-value="license">
                    <div class="icon-container"><img src=" {{ asset ('tatto_license_icon.png') }}" class="icon" alt="License Icon"></div>
                    <div class="option-text"><strong>{{ __('tattoo_heading') }}</strong><span>{{ __('tattoo_message') }}</span></div>
{{--                    <div class="checkmark">✓</div>--}}
                    <div class="tick">
                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21 7.81817L9 19.8182L3.5 14.3182L4.91 12.9082L9 16.9882L19.59 6.40817L21 7.81817Z" fill="#014122" stroke="#014122"/>
        ...
        <div class="form-step" data-step="1">
            ...
            <label for="front-id-input" class="upload-area" id="front-upload-area">
                <div class="upload-content">
                    <img id="step-2-placeholder-img" src="{{ asset ('id_card.png') }}" class="id-frame-overlay" alt="ID Card Placeholder">
                </div>
            </label>
        ...
        <div class="form-step" data-step="2">
            ...
            <label for="back-id-input" class="upload-area" id="back-upload-area">
                <div class="upload-content">
                    <img src="{{ asset ('id_card.png') }}" class="id-frame-overlay" alt="ID Card Placeholder">
                </div>
            </label>
        ...
        <div class="form-step" data-step="3">
            ...
            <div class="confirmation-previews" id="confirmation-previews">
                <div class="preview-container" id="front-preview-container">
                    ...
                    <img id="front-preview-img" src="{{ asset ('id_card.png') }}" alt="Front ID Preview">
                </div>
                <div class="preview-container" id="back-preview-container">
                    ...
                    <img id="back-preview-img" src="{{ asset ('id_card.png') }}" alt="Back ID Preview">
                </div>
            </div>
            <div class="button-group">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        let idCardUrl = "{{ asset('id_card.png') }}";
        ...
        {{--    // Progress bars ko unki ID se pakdein--}}
        ...
        {{--    // Progress bars ke liye HTML content--}}
        {{--    const three_steps_1_active = '<div class="progress-step active"></div><div class="progress-step"></div><div class="progress-step"></div>';--}}
        {{--    const three_steps_2_active = '<div class="progress-step active"></div><div class="progress-step active"></div><div class="progress-step"></div>';--}}
        {{--    const three_steps_3_active = '<div class="progress-step active"></div><div class="progress-step active"></div><div class="progress-step active"></div>';--}}

        {{--    const two_steps_1_active = '<div class="progress-step active"></div><div class="progress-step"></div>';--}}
        {{--    const two_steps_2_active = '<div class="progress-step active"></div><div class="progress-step active"></div>';--}}
        ...
        {{--        // ID Card ke liye 3 steps dikhayein--}}
        ...
        {{--    } else { // Passport aur License ke liye--}}
        {{--        const docName = selectedDocType === 'passport' ? 'Passport' : 'Tattoo License';--}}
        {{--        const docIcon = selectedDocType === 'passport' ? "{{ asset ('passport_icon.png') }}" : "{{ asset('tatto_license_icon.png') }}" ;--}}

        {{--        step2Title.textContent = `${docName} Verification`;--}}
        {{--        step2Desc.textContent = `Upload a photo of your ${docName}.`;--}}
        {{--        step2Placeholder.src = docIcon;--}}
        {{--        confirmationTitle.textContent = `Confirm Your ${docName}`;--}}
        {{--        frontPreviewLabel.textContent = `${docName} Image`;--}}
        {{--        backPreviewContainer.style.display = 'none';--}}
        {{--        confirmationPreviews.classList.add('single');--}}

        {{--        // Passport/License ke liye 2 steps dikhayein--}}
        ...
        nextBtns.forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                if (currentStep === 1 && (selectedDocType === 'passport' || selectedDocType === 'license')) {
                    nextStep = 3;
                }
        ...
        backBtns.forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                if (currentStep === 3 && (selectedDocType === 'passport' || selectedDocType === 'license')) {
                    prevStep = 1;
                }
