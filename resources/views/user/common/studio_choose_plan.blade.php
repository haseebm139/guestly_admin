...
<head>
    ...
    <style>
        ...
        .billing-toggle {
            ...
            margin-bottom: 40px;
            font-size: 16px;
            user-select: none; /* ROKTA HAI TEXT KO SELECT HONE SE */
            font-family: 'Arial Rounded MT Bold', sans-serif;
            font-weight: 500;
        }
        ...
        .slider {
            ...
            right: 5px;
            bottom: 6px;
            background-color: var(--primary-green); /* TRACK KA COLOR */
            transition: .4s;
            border-radius: 10px;
        }
        ...
        .slider:before {
            position: absolute;
            content: "";
            height: 30px; /* HANDLE KA SIZE */
            width: 30px;  /* HANDLE KA SIZE */
            left: -5px;
            bottom: -6px;
            background-color: #e6f4f0; /* HANDLE KE ANDAR KA COLOR */
            border: 3px solid var(--primary-green); /* BORDER JISSE HOLLOW LOOK AAYEGA */
            box-sizing: border-box; /* IMPORTANT: Border ko size me include karne ke liye */
            transition: .4s;
            border-radius: 50%;
        }

        input:checked + .slider:before {
            transform: translateX(22px); /* SLIDE HONE KA DISTANCE */
        }

        /* === END: TOGGLE SWITCH KA NAYA CODE YAHAN KHATAM HOTA HAI === */

        .pricing-container { display: flex; gap: 30px; width: 100%; }
        ...
        .plan-card {
            ...
            padding: 30px;
            padding-bottom: 50px;
            box-shadow: inset 0 0 15px rgba(11, 61, 39, 0.1), /* light inner shadow */
            0 0 10px rgba(11, 61, 39, 0.05);     /* light outer shadow */
        }

        .plan-card.active {
            border-color: #014122;
            box-shadow: inset 0 0 15px rgba(11, 61, 39, 0.3), /* green inner shadow */
            0 0 15px rgba(11, 61, 39, 0.2);       /* outer glow shadow */
            transform: scale(1.02);
        }
        .plan-card h3 { font-size: 25px; font-weight: 500; margin: 0 0 15px 0; text-align: center; color: var(--text-secondary); transition: color 0.3s ease; }
        ...
        .plan-card.active hr {
            background-color: #5E8082; /* dark color for active */
        }
        .features-list {
            list-style: none;
            padding: 0;
        ...
        .features-list li .tick-icon {
            width: 15px; /* adjust for your PNG */
            height: 12px;
            flex-shrink: 0;
            margin-top: 6px;
        ...
        .plan-card.active .tick-icon {
            opacity: 1; /* full lightup when active */
        }
        ...
        .plan-card.active .plan-button { background-color: #014122; color: white; }
        .plan-card:not(.active) .plan-button { background-color: var(--secondary-green); color: white; }
        .continue-btn {
        ...
        .start-verification-btn { background-color: var(--primary-green); color: white; border: none; border-radius: 50px; padding: 15px; width: 100%; font-size: 16px; font-weight: 500; cursor: pointer; font-family: 'Arial Rounded MT Bold', sans-serif;
        }
    ...
    <div class="pricing-container">
        <div class="plan-card active">
            ...
            <ul class="features-list">
                <li><img src="/extra/vector.png" alt="tick" class="tick-icon"> 1 active studio request at a time.</li>
                <li><img src="/extra/vector.png" alt="tick" class="tick-icon"> Basic guest artist profile.</li>
                <li><img src="/extra/vector.png" alt="tick" class="tick-icon"> Messaging with studios (limited).</li>
                <li><img src="/extra/vector.png" alt="tick" class="tick-icon"> Studio calendar viewing (read-only).</li>
                <li><img src="/extra/vector.png" alt="tick" class="tick-icon"> Studio seat availability view.</li>
            </ul>
        ...
        <div class="plan-card">
            ...
            <ul class="features-list">
                ...
                <li><img src="/extra/vector.png" alt="tick" class="tick-icon"> Full booking management tools.</li>
                <li><img src="/extra/vector.png" alt="tick" class="tick-icon"> Advanced guest artist profile.</li>
                <li><img src="/extra/vector.png" alt="tick" class="tick-icon"> Priority messaging and real-time chat.</li>
    ...
    <div class="modal-content">
        <form>
            ...
            <div class="payment-methods">
                ...
                </div><div class="method-card"><img src="https://upload.wikimedia.org/wikipedia/commons/b/b5/PayPal.svg" alt="PayPal">
                </div>
            </div>
...
<div class="modal-overlay" id="success-modal">
    <div class="modal-content success-modal-content">
        ...
        <img class="success-icon" src="/thumbs_up.png" alt="Success Thumbs Up">

        <h2>You're Subscribed!</h2>
        <p>Your Free subscription is now active. You're all set to start requesting studio spots, managing your bookings, and showcasing your profile like a pro.</p>
        <button class="start-verification-btn" onclick="window.location.href='user_identification'">Start Verification</button>
    </div>
</div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        openModalBtn.addEventListener('click', (e) => {
            ...
            if (activePlan === 'Free Tier') {
                ...
                successParagraph.innerText = "Your Free Tier subscription is now active. You can start requesting studio spots with limited features. Upgrade anytime to unlock full booking management tools.";
        ...
        payNowBtn.addEventListener('click', (e) => {
            ...
            successHeading.innerText = "You're Subscribed!";
            successParagraph.innerText = "Your Pro Tier subscription is now active. You're all set to start requesting studio spots, managing your bookings, and showcasing your profile like a pro.";
