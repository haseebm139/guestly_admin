...
<style>
    ...
    /* Main Container Card */
    .content-card {
        background-color: #E6F4F0; /* Main card ka background white */
        border-radius: 24px;
    ...
    .card_image_wrapper {
        position: relative;
        padding: 10px; /* Yeh image ke gird white gap banayega */
    }
    ...
    .swiper_slider img {
        ...
        height: 200px;
        object-fit: cover;
        border-radius: 12px; /* Image ke corners ko round karega */
    }
    ...
    .card-actions button:hover {
        ...
        transform-origin: center; /* jahan se bell hang hoti hai */
    }
    ...
    .edit-guest-modal-content {
        background-color: #fff; padding: 24px; border-radius: 24px;
        width: 100%; max-width: 550px;
        box-shadow: 0 10px 40px rgba(0,0,0,0.1);
        position: relative;
        display: flex; flex-direction: column;
        max-height: 70vh; /* Modal ki max height set ki */
    }

    .edit-guest-modal-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; }
    .edit-guest-modal-title { font-size: 22px; font-weight: 700; margin-left: 80px; color: var(--dark-green); }
    .edit-guest-modal-close-btn {
        background-color: var(--dark-green); color: #fff; border: none;
        width: 32px; height: 32px; border-radius: 50%;
        font-size: 20px; font-weight: bold;
        display: flex; justify-content: center; align-items: center;
        cursor: pointer; line-height: 1;
    }
    .edit-guest-modal-image-wrapper { position: relative; margin-bottom: 24px; }
    .edit-guest-modal-image-wrapper .main-image { width: 100%; height: 220px; object-fit: cover; border-radius: 16px; }
    .edit-guest-modal-image-overlay {
        position: absolute; bottom: 0; left: 60px; right: 0; padding: 20px;
        background: linear-gradient(to top, rgba(0,0,0,0.8), transparent);
        border-radius: 0 0 16px 16px; display: flex; align-items: center; gap: 12px;
    }
    .edit-guest-modal-image-overlay .logo { width: 40px; height: 40px; border-radius: 50%; }
    .edit-guest-modal-image-overlay .studio-info p { margin: 0; color: #fff; font-weight: 600; font-size: 18px; }
    .edit-guest-modal-image-overlay .studio-info span { margin: 0; color: #e0e0e0; font-size: 13px; display: flex; align-items: center; gap: 5px; }
    .edit-guest-modal-image-overlay .studio-info span svg { width: 14px; height: 14px; fill: #fff; }
    ...
    .edit-guest-modal-form-group {
        border: 1px solid #5e8082; border-radius: 12px;
        padding: 12px 16px; position: relative;
    }
    .edit-guest-modal-form-group.textarea-group { padding-bottom: 50px; }
    .edit-guest-modal-form-group label { font-size: 12px; color: #5e8082; display: block; margin-bottom: 4px; }
    ...
    .edit-guest-modal-form-group .value-input {
        font-size: 15px; font-weight: 500; color: var(--text-dark);
        border: none; outline: none; padding: 0; width: calc(100% - 50px);
        background: transparent; font-family: inherit;
    }
    .edit-guest-modal-form-group textarea {
        width: 100%; border: none; outline: none; resize: none;
        font-size: 15px; color: var(--text-dark); padding: 0;
    ...
    .edit-guest-modal-date-fields { display: flex; gap: 16px; }
    .edit-guest-modal-date-fields .edit-guest-modal-form-group { flex: 1; }
    .edit-guest-modal-form-group .update-btn {
        position: absolute; bottom: 12px; right: 16px; background: #e6f4f0;
        color: var(--dark-green); border: 1px solid #b2dfdb; border-radius: 50px;
        padding: 6px 16px; font-weight: 600; cursor: pointer;
    }
    .edit-guest-modal-footer { margin-top: 24px; flex-shrink: 0; }
    .edit-guest-modal-footer .rebook-btn {
        width: 100%; background: var(--dark-green); color: #fff; border: none;
        border-radius: 50px; padding: 14px; font-size: 16px;
                ...
                <div class="studio-card-wrapper">
                    <div class="card_image_wrapper">
                        <div class="swiper swiper_slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img src="{{ asset('dashboard/default_1_profile.jpg') }}" alt="Studio Image"></div>
                                <div class="swiper-slide"><img src="{{ asset('dashboard/default_2_profile.jpg') }}" alt="Studio Image"></div>
                                <div class="swiper-slide"><img src="{{ asset('dashboard/default_3_profile.jpg') }}" alt="Studio Image"></div>
                            </div>
                        ...
                        <div class="card-actions">
                            <button title="Edit" class="js-open-edit-guest-modal">
                                <svg width="20" height="20" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M5.00282 5.75742H4.25246C3.85444 5.75742 3.47272 5.91553 3.19128 6.19697C2.90984 6.47841 2.75172 6.86013 2.75172 7.25815V14.0114C2.75172 14.4095 2.90984 14.7912 3.19128 15.0726C3.47272 15.3541 3.85444 15.5122 4.25246 15.5122H11.0058C11.4038 15.5122 11.7855 15.3541 12.0669 15.0726C12.3484 14.7912 12.5065 14.4095 12.5065 14.0114V13.2611M11.7561 4.25668L14.0072 6.50778M15.0465 5.446C15.342 5.15047 15.508 4.74965 15.508 4.33171C15.508 3.91377 15.342 3.51294 15.0465 3.21741C14.7509 2.92189 14.3501 2.75586 13.9322 2.75586C13.5142 2.75586 13.1134 2.92189 12.8179 3.21741L6.50356 9.50924V11.7603H8.75465L15.0465 5.446Z" stroke="#014122" stroke-width="1.50073" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </button>
                            <button title="Delete">
                                <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.27034 3.75732H13.2762M5.77254 6.75879V11.261M8.774 6.75879V11.261M2.02071 3.75732L2.77107 12.7617C2.77107 13.1597 2.92918 13.5415 3.21063 13.8229C3.49207 14.1043 3.87379 14.2625 4.2718 14.2625H10.2747C10.6728 14.2625 11.0545 14.1043 11.3359 13.8229C11.6174 13.5415 11.7755 13.1597 11.7755 12.7617L12.5258 3.75732M5.02217 3.75732V1.50623C5.02217 1.30722 5.10123 1.11636 5.24195 0.975636C5.38267 0.834916 5.57353 0.755859 5.77254 0.755859H8.774C8.97301 0.755859 9.16387 0.834916 9.30459 0.975636C9.44531 1.11636 9.52437 1.30722 9.52437 1.50623V3.75732" stroke="#014122" stroke-width="1.50073" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="card_content_wrapper">
                        <div class="card-header-wrapper">
                            <img src="{{ asset('dashboard/default_1.png') }}" alt="Studio Logo" class="card-logo-wrapper">
        ...
        <div id="editGuestSpotModal" class="edit-guest-modal-overlay">
            <div class="edit-guest-modal-content">
                ...
                <div class="edit-guest-modal-image-wrapper">
                    <img src="{{ asset('dashboard/default_1_profile.jpg') }}" alt="Studio Tattoo" class="main-image">
                    <div class="edit-guest-modal-image-overlay">
                        <img src="{{ asset('dashboard/default_1.png') }}" alt="Studio Logo" class="logo">
                ...
                <div class="edit-guest-modal-body">
                    ...
                    <div class="edit-guest-modal-form-group" data-editable-field>
                        ...
                        <input type="text" class="value-input" value="San Diego, California, USA" style="display: none;">
                        <a class="edit-link">Edit</a>
                    </div>
