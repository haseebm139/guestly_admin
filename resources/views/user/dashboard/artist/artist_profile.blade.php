...
<style>
    :root {
        ...
        --dark-green: #004D40;
        --text-color: #333;
        --label-color: #868e96; /* Thora halka color label ke liye */
        --border-color: #ced4da;
    }
    .profile-page-wrapper { background-color: var(--light-green-bg); padding: 40px 20px; width: 100%; display: flex; justify-content: center; font-family: 'Inter', sans-serif; }
    ...
    .profile-header { background-color: var(--card-header-bg); border-radius: 16px; padding: 24px; text-align: center; margin-bottom: 24px; }
    .profile-picture { width: 90px; height: 90px; border-radius: 50%; object-fit: cover; margin-bottom: 12px; }
    .profile-name { font-size: 22px; font-weight: 600; color: #014122; margin: 0; }
    .profile-role { font-size: 14px; color: #555; margin: 4px 0 0; }
    .verification-section { display: flex; justify-content: space-between; align-items: center; border: 1px solid #5E8082; padding: 16px; border-radius: 12px; margin-bottom: 24px; }
    .verification-section h3 { margin: 0; font-size: 16px; font-weight: 600; color: var(--dark-green); }
    .verified-status { display: flex; align-items: center; gap: 8px; color: var(--dark-green); font-weight: 600; font-size: 16px; }
    .verified-status svg { width: 20px; height: 20px; fill: var(--dark-green); }
    ...
    .info-field {
        ...
        align-items: center; /* Vertically center the button with the content block */
        border: 1px solid #5E8082;
        border-radius: 12px;
        padding: 8px 16px; /* Vertical padding kam ki gayi hai */
    }

    .field-data {
        flex-grow: 1; /* Taake yeh poori available space le le */
    }

    .field-label {
        display: block; /* Label ko apni line par rakho */
        font-size: 12px;
        color: #5E8082;
        margin-bottom: 2px; /* Label aur value ke beech thori si space */
    }
    ...
    .editable-input {
        display: block; /* Isko bhi block banaya taake yeh poori width le */
        width: 100%;
        border: none;
    ...
    .action-btn { background: none; border: none; color: #014122; font-weight: 600; font-size: 15px; cursor: pointer; padding: 0 0 0 10px; text-decoration: underline; }
    .save-changes-container { text-align: center; margin-top: 32px; }
    .save-changes-btn { background-color: #014122; color: #fff; border: none; padding: 18px 40px; border-radius: 50px; font-size: 16px; font-weight: 600; cursor: pointer; }
    ...
    <div class="profile-page-wrapper">
        <div class="profile-card-container">
            ...
            <div class="profile-header">
                <img src="{{ asset ('dashboard/user-profile.jpg') }}" alt="Profile Picture" class="profile-picture">
                ...
                <div class="info-grid mt-4">
                    ...
                    <div class="info-field">
                        <div class="field-data">
                            ...
                            <input type="text" name="legal_name" class="editable-input" value="Chris Johnson" style="display: none;">
                        </div>
                    ...
                    <div class="info-field">
                        <div class="field-data">
                            ...
                            <input type="email" name="email" class="editable-input" value="chris@gmail.com" style="display: none;">
                        </div>
                        <button type="button" class="action-btn toggle-edit-btn" data-original-text="Edit">Edit</button>
                    </div>
                    ...
                    <div class="info-field">
                        <div class="field-data">
                            ...
                            <input type="text" name="country" class="editable-input" value="United States" style="display: none;">
                        </div>
                        <button type="button" class="action-btn toggle-edit-btn" data-original-text="Edit">Edit</button>
                    </div>
                    ...
                    <div class="info-field">
                        <div class="field-data">
                            ...
                            <input type="tel" name="phone" class="editable-input" value="+1 123 456 789" style="display: none;">
                        </div>
                        <button type="button" class="action-btn toggle-edit-btn" data-original-text="Edit">Edit</button>
                    </div>
                    ...
                    <div class="info-field info-field-full">
                        <div class="field-data">
                            ...
                            <input type="text" name="address" class="editable-input" value="" placeholder="Enter your address" style="display: none;">
                        </div>
                    ...
                    <div class="info-field info-field-full">
                        <div class="field-data">
                            ...
                            <span class="value">Not Provided</span>
                            <input type="tel" name="emergency_contact" class="editable-input" value="" placeholder="Enter emergency contact" style="display: none;">
                        </div>
                        <button type="button" class="action-btn toggle-edit-btn" data-original-text="Add">Add</button>
                    </div>
                </div>
