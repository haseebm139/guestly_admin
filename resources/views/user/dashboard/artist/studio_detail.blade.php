...
{{--                </section>--}}
                <section class="location-map-container">
                    <h2 class="section-title-md">Our Location</h2>
                    <div class="booking-card">
                        <div class="booking-card-content"><svg class="calendar-icon" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10z"/></svg> <span>Calendar Availability</span></div>
                ...
                <div class="form-step active" data-step="0">
                    ...
                    <div class="form-content-scrollable">
                        ...
                        <div class="date-range-inputs">
                            <div class="form-group"><label>From</label><div class="date-display" id="from-date-display"></div></div>
                            <div class="form-group"><label>To</label><div class="date-display" id="to-date-display"></div></div>
                        </div>
                        <div class="field-row-bordered">
                            <span>Request a Studio Tour</span>
                            <div class="billing-toggle"><span>Yes</span><label class="switch"><input type="checkbox" checked><span class="slider"></span></label><span>No</span></div>
                        </div>
                    </div>
                    <div class="button-group"><button class="nav-btn back-btn" disabled>Back</button><button class="nav-btn next-btn">Next</button></div>
                </div>
...
{{--                    <h2>Book your Spot</h2>--}}
{{--                    <p class="subtitle">Please proceed to book your guest spot as an artist.</p>--}}
{{--                    <div class="progress-indicator"><div class="progress-step"></div><div class="progress-step"></div><div class="progress-step"></div><div class="progress-step"></div></div>--}}
{{--                    <div class="form-content-scrollable">--}}
{{--                        <div class="form-group"><label for="file-type">File Type</label><select id="file-type"><option>Portfolio</option><option>CV</option></select></div>--}}
{{--                        <div class="upload-box-dotted" id="upload-box"><span class="icon">&#128228;</span> Upload File</div>--}}
{{--                        <input type="file" id="file-input" hidden>--}}
{{--                        <p style="font-size:12px; color: var(--text-secondary); margin-top: 10px;">You can upload PDF, JPG, PNG, or ZIP files up to 50MB each.</p>--}}
{{--                        <div class="uploaded-file-row" id="uploaded-file-row">--}}
{{--                            <span class="file-icon">&#128196;</span>--}}
{{--                            <div class="file-info">--}}
{{--                                <span class="file-name" id="file-name-display"></span>--}}
{{--                                <div class="file-progress-bar"><div class="file-progress" id="file-progress-bar"></div></div>--}}
{{--                            </div>--}}
{{--                            <span class="file-size" id="file-size-display"></span>--}}
{{--                            <span class="file-remove" id="file-remove-btn">&times;</span>--}}
{{--                        </div>--}}
{{--                    </div>--}}
                    ...
                    <div class="form-content-scrollable">
                        ...
                        <div class="upload-box-dotted" id="upload-box">
                            <div class="upload-box-content">
                                <svg class="upload-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14 2H6C5.46957 2 4.96086 2.21071 4.58579 2.58579C4.21071 2.96086 4 3.46957 4 4V20C4 20.5304 4.21071 21.0391 4.58579 21.4142C4.96086 21.7893 5.46957 22 6 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V8L14 2Z" stroke="#0B3D27" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M14 2V8H20" stroke="#0B3D27" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 18V12" stroke="#0B3D27" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 15L12 12L15 15" stroke="#0B3D27" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                        ...
                        <p class="upload-info-text">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15Z" stroke="#5D7A70" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 10.5V8" stroke="#5D7A70" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 5.5H8.0075" stroke="#5D7A70" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
...
{{--                        </div>--}}
                        <div class="file-icon-container">
                            <img src="{{ asset ('document.png') }}" width="60" height="80" alt="File Preview" />
                        </div>
                        <div class="file-info">
                ...
                <div class="form-step" data-step="2">
                    ...
                    <div class="progress-indicator"><div class="progress-step"></div><div class="progress-step"></div><div class="progress-step"></div><div class="progress-step"></div></div>
                    <div class="form-content-scrollable">
                        <div class="form-group"><label>Leave a Message for the Studio (Optional)</label><textarea placeholder="Write Something Here..."></textarea></div>
                        <div class="artist-details-group">
                            <div class="form-group"><label>Are You Booking Solo or With a Group?</label><select><option>Group</option><option>Solo</option></select></div>
                            <div class="form-group" style="margin-top:15px;"><label>Name of the Artist</label><input type="text" value="Jessica L."></div>
                ...
                <div class="form-step" data-step="3">
                    ...
                    <div class="form-content-scrollable">
                        ...
                        <div class="agreement-box">
                            ...
                            <p>Before submitting your booking request, please take a moment to carefully review and agree to our Guest Artist Terms & Conditions. These terms have been created to ensure a smooth, professional, and respectful experience for both you and the studio.</p>
                            <br>
                            <p>As a guest artist, you are expected to adhere to all studio policies, which include but are not limited to:</p><br>
                            <ul>
                                <li><strong>Health & Hygiene Standards:</strong> Maintaining a clean and sanitary workspace at all times, properly sterilizing equipment, and following all local health regulations.</li>
                                <li><strong>Professional Conduct:</strong> Treating staff, clients, and fellow artists with respect and professionalism. Any form of discrimination, harassment, or unprofessional behavior will not be tolerated.</li>
                                <li><strong>Client Management:</strong> Being responsible for your own clients, including their communication, comfort, and consent throughout the session.</li>
                                <li><strong>Studio Property & Etiquette:</strong> Respecting the space, equipment, and any provided resources. Any damage caused will be your responsibility.</li>
                                <li><strong>Scheduling & Punctuality:</strong> Arriving on time for your scheduled days and informing the studio in advance if there are any changes or emergencies.</li>
                            </ul>
                            <br>
                            <p>By agreeing to these terms, you acknowledge your role in maintaining the studio's reputation and creating a safe, welcoming environment for everyone. Failure to comply may result in your booking being canceled.</p>
                        </div>
                    </div>
                    <div class="button-group"><button class="nav-btn back-btn">Back</button><button class="nav-btn agree-btn" id="agree-btn">Agree and Continue</button></div>
                </div>
                ...
                <div class="form-step" style="margin-bottom: -50px" data-step="4">
                    <div class="final-modal-content">
                        ...
                        <p>Thank you! Your booking request has been successfully submitted and is now pending studio approval. You’ll receive a notification once the studio reviews and responds to your request.'</p>
                        <div class="button-group"><button class="nav-btn next-btn" id="submitted-continue-btn">Continue</button></div>
                    </div>
                </div>
...
{{--            const tourToggle = document.querySelector('.billing-toggle');--}}

{{--            // --- STEP 2: UPLOAD ELEMENTS (Corrected) -----}}
...
{{--            const uploadedFiles = new Map(); // Store files here--}}

{{--            // --- MODAL CONTROLS & BLUR EFFECT -----}}
{{--            const openModal = () => {--}}
...
{{--                setTimeout(() => goToStep(0), 300); // Reset to first step after closing--}}
{{--            };--}}
...
{{--            // --- CALENDAR LOGIC -----}}
{{--            const formatDate = (d) => d ? d.toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' }) : "";--}}
{{--            const toISO = (d) => `${d.getFullYear()}-${(d.getMonth() + 1).toString().padStart(2, '0')}-${d.getDate().toString().padStart(2, '0')}`;--}}
{{--            const renderCalendar = () => {--}}
{{--                const year = currentDate.getFullYear(), month = currentDate.getMonth();--}}
{{--                monthYearDisplay.textContent = `${monthNames[month]} ${year}`;--}}
{{--                calendarGridBody.innerHTML = '';--}}
{{--                ['M', 'T', 'W', 'T', 'F', 'S', 'S'].forEach(d => calendarGridBody.innerHTML += `<div class="day-cell day-name">${d}</div>`);--}}
{{--                const startDayIndex = (new Date(year, month, 1).getDay() + 6) % 7;--}}
{{--                for (let i = 0; i < startDayIndex; i++) calendarGridBody.innerHTML += `<div class="day-cell other-month"></div>`;--}}
{{--                for (let day = 1; day <= new Date(year, month + 1, 0).getDate(); day++) {--}}
{{--                    const cell = document.createElement('div'), cellDate = new Date(year, month, day);--}}
{{--                    cell.className = 'day-cell'; cell.textContent = day.toString().padStart(2, '0'); cell.dataset.date = toISO(cellDate);--}}
{{--                    if (startDate && toISO(cellDate) === toISO(startDate)) cell.classList.add('start-date');--}}
{{--                    if (endDate && toISO(cellDate) === toISO(endDate)) cell.classList.add('end-date');--}}
...
{{--                updateDateInputs();--}}
{{--            };--}}
{{--            const updateDateInputs = () => { fromDateDisplay.textContent = formatDate(startDate); toDateDisplay.textContent = formatDate(endDate); };--}}
...
{{--                            const fileData = { file: file, timestamp: new Date() };--}}
...
{{--                // fileRow.querySelector('.file-time').textContent = timeAgo(timestamp);--}}
{{--                const timeEl = fileRow.querySelector('.file-time');--}}
{{--                timeEl.textContent = timeAgo(timestamp);--}}
{{--                timeEl.dataset.timestamp = timestamp; // Save raw timestamp for real-time update--}}
...
{{--                if (s >= 31536000) return Math.floor(s / 31536000) + "y ago";     // years--}}
{{--                if (s >= 2592000)  return Math.floor(s / 2592000) + "mo ago";     // months--}}
{{--                if (s >= 86400)    return Math.floor(s / 86400) + "d ago";        // days--}}
{{--                if (s >= 3600)     return Math.floor(s / 3600) + "h ago";         // hours--}}
{{--                if (s >= 60)       return Math.floor(s / 60) + "m ago";           // minutes--}}
{{--                if (s > 0)         return s + "s ago";                            // seconds--}}
{{--                return "just now";--}}
{{--            }--}}
...
{{--    </script>--}}
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const openModal = () => { document.body.classList.add('modal-is-open'); modalOverlay.classList.add('active'); }
            const closeModal = () => { document.body.classList.remove('modal-is-open'); modalOverlay.classList.remove('active'); setTimeout(() => goToStep(0), 300); };
            if(openModalBtn) openModalBtn.addEventListener('click', openModal);
            if(closeModalBtn) closeModalBtn.addEventListener('click', closeModal);
            if(modalOverlay) modalOverlay.addEventListener('click', (e) => { if (e.target === modalOverlay) closeModal(); });
            function goToStep(stepIndex) { if (stepIndex >= steps.length || stepIndex < 0) return; steps[currentStep].classList.remove('active'); steps[stepIndex].classList.add('active'); currentStep = stepIndex; updateProgressBar(); const backBtn = steps[stepIndex].querySelector('.back-btn'); if(backBtn) backBtn.disabled = (stepIndex === 0); }
            const updateProgressBar = () => { const indicators = document.querySelectorAll('.progress-indicator'); indicators.forEach(indicator => { if (indicator) { const progressSteps = indicator.querySelectorAll('.progress-step'); progressSteps.forEach((progress, progressIdx) => { progress.classList.toggle('active', progressIdx < currentStep); }); if (progressSteps[currentStep]) { progressSteps[currentStep].classList.add('active'); } } }); };
            nextBtns.forEach(btn => btn.addEventListener('click', () => { if (btn.id === 'agree-btn') goToStep(4); else if (currentStep < steps.length - 1) goToStep(currentStep + 1); }));
            backBtns.forEach(btn => btn.addEventListener('click', () => { if (currentStep > 0) goToStep(currentStep - 1); }));
            document.getElementById('submitted-continue-btn')?.addEventListener('click', closeModal);
            ...
            const updateDateInputs = () => { fromDateDisplay.textContent = formatDate(startDate); toDateDisplay.textContent = formatDate(endDate); };
            const handleDateClick = (e) => { const clickedDate = new Date(e.target.dataset.date + 'T00:00:00'); if (!startDate || (startDate && endDate)) { startDate = clickedDate; endDate = null; } else if (clickedDate < startDate) { startDate = clickedDate; } else { endDate = clickedDate; } renderCalendar(); };
            prevMonthBtn.addEventListener('click', () => { currentDate.setMonth(currentDate.getMonth() - 1); renderCalendar(); });
            nextMonthBtn.addEventListener('click', () => { currentDate.setMonth(currentDate.getMonth() + 1); renderCalendar(); });
            renderCalendar();

            // File Upload Logic (No changes needed)
            if (uploadBox && fileInput && imagePreviewGallery && uploadedFilesList && fileTemplate) { uploadBox.addEventListener('click', () => fileInput.click()); fileInput.addEventListener('change', (event) => { const files = event.target.files; for (const file of files) { const fileKey = `${file.name}-${file.size}`; if (!uploadedFiles.has(fileKey)) { const fileData = { file: file, timestamp: new Date() }; uploadedFiles.set(fileKey, fileData); renderFile(fileKey, fileData); } } fileInput.value = ''; }); }
            function renderFile(key, data) { const { file, timestamp } = data; const templateClone = fileTemplate.content.cloneNode(true); const fileRow = templateClone.querySelector('.uploaded-file-row'); fileRow.dataset.key = key; fileRow.querySelector('.file-name').textContent = file.name; const timeEl = fileRow.querySelector('.file-time'); timeEl.textContent = timeAgo(timestamp); timeEl.dataset.timestamp = timestamp; fileRow.querySelector('.file-size-pill').textContent = formatBytes(file.size); fileRow.querySelector('.file-remove-btn').addEventListener('click', () => removeFile(key)); if (file.type.startsWith('image/')) { const img = document.createElement('img'); img.src = URL.createObjectURL(file); img.dataset.key = key; imagePreviewGallery.appendChild(img); } uploadedFilesList.appendChild(fileRow); }
            function removeFile(key) { const fileRow = uploadedFilesList.querySelector(`.uploaded-file-row[data-key="${key}"]`); if (fileRow) fileRow.remove(); const imgPreview = imagePreviewGallery.querySelector(`img[data-key="${key}"]`); if (imgPreview) imgPreview.remove(); uploadedFiles.delete(key); }
            function formatBytes(bytes, d=2) { if (bytes === 0) return '0 Bytes'; const k = 1024, i = Math.floor(Math.log(bytes) / Math.log(k)); return `${parseFloat((bytes / Math.pow(k, i)).toFixed(d))} ${['Bytes', 'KB', 'MB', 'GB'][i]}`; }
            function timeAgo(date) { const s = Math.floor((new Date() - date) / 1000); if (s >= 31536000) return Math.floor(s / 31536000) + "y ago"; if (s >= 2592000)  return Math.floor(s / 2592000) + "mo ago"; if (s >= 86400)    return Math.floor(s / 86400) + "d ago"; if (s >= 3600)     return Math.floor(s / 3600) + "h ago"; if (s >= 60)       return Math.floor(s / 60) + "m ago"; if (s > 0)         return s + "s ago"; return "just now"; }
            function updateAllFileTimes() { document.querySelectorAll('.file-time').forEach(el => { const ts = el.dataset.timestamp; if (ts) el.textContent = timeAgo(new Date(ts)); }); }
            setInterval(updateAllFileTimes, 10000);
            goToStep(0);
        });
    </script>
