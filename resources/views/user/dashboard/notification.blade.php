...
{{--    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">--}}
    ...
    <style>
        ...
        body {
            ...
            background-color: #f8f9fa; /* Page ka background color */
        }
        ...
        .notifications-header {
            display: flex;
            justify-content: flex-start; /* Button ko left par rakhega */
            align-items: center;
            margin-bottom: 24px;
            padding-bottom: 20px;
        ...
        .btn-mark-all {
            background-color: #00AEEF; /* Image wala blue color */
            border: none;
            color: #fff;
            font-weight: 600;
            font-size: 15px;
        ...
        .notification-item {
            display: flex;
            align-items: center;
            padding: 16px 8px; /* Thodi si padding */
            border-bottom: 1px solid #e9ecef;
        }

        .notification-item:last-child {
            border-bottom: none; /* Aakhri item ke neeche line nahi hogi */
        }
        ...
        .notification-content {
            flex-grow: 1; /* Taake yeh poori jagah le le */
        }
        ...
        .notification-content p {
            ...
            line-height: 1.5;
            font-size: 15px;
            color: #6c757d; /* Text ka halka color */
        }

        .notification-content strong {
            color: #212529; /* Name ka dark color */
            font-weight: 600;
        }
        ...
        .unread-dot {
            width: 10px;
            height: 10px;
            background-color: #00AEEF; /* Image wala blue dot */
            border-radius: 50%;
        }
