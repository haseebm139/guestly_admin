...
<style>
    ...
    .page-header-wrapper {
        display: flex;
        justify-content: flex-start; /* Items ko left se start karega */
        align-items: center;
        margin-bottom: 24px;
    }
    ...
    .header-actions {
        display: flex;
        align-items: center;
        gap: 16px; /* Search aur filter ke beech space */
    }
    ...
    .search-bar input {
        ...
        font-size: 16px;
        width: 350px; /* Thori si fixed width dedi */
    ...
    <div class="page-header-wrapper">
        <div class="header-actions">
            ...
            <button class="filter-btn">
                ...
                <span>Filter</span>
                <svg class="dropdown-arrow" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7 10L12 15L17 10" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
            </button>
        </div>
    </div>
        ...
        <div class="artist-card">
            <div class="card_image_wrapper">
                <div class="swiper swiper_slider">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide"><img src="{{ asset('dashboard/default_1_profile.jpg') }}" alt="Artwork"></div>
                        <div class="swiper-slide"><img src="{{ asset('dashboard/default_2_profile.jpg') }}" alt="Artwork"></div>
                        <div class="swiper-slide"><img src="{{ asset('dashboard/default_3_profile.jpg') }}" alt="Artwork"></div>
                    </div>
            ...
            <div class="card_content_wrapper">
                <div class="artist-header">
                    ...
                    <img src="{{ asset('dashboard/default_1.png') }}" alt="Artist Name" class="artist-profile-pic">
                    ...
                    <div class="message-icon">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="#014122" xmlns="http://www.w3.org/2000/svg"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"></path></svg>
                    </div>
                </div>
                ...
                <p class="artist-bio">
                    ...
                    I'm a passionate tattoo artist known for bold linework, fine detail, and custom designs that tell a story. With over 6 years of experience, Riley specializes in neo-traditional, blockwork, and botanical-inspired pieces.
                </p>
            </div>
        </div>
        @endfor
