...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/style.css') }}"> {{-- Best practice for Laravel --}}
    ...
    <div class="filter-modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="date-inputs-container">
                <div class="date-input-group"><label class="form-label-small">From</label><div id="from-date-display" class="date-input-display"></div></div>
                <div class="date-input-group"><label class="form-label-small">To</label><div id="to-date-display" class="date-input-display"></div></div>
            </div>

            <!-- Studio Type Dropdown -->
            <div class="form-section"><label class="form-label-small">Studio Type</label><div class="custom-select"><span>Private Studio</span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/></svg></div></div>

            <!-- Country/Region Dropdown -->
            <div class="form-section"><label class="form-label-small">Country/Region</label><div class="custom-select"><span>United States (+1)</span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/></svg></div></div>
        </div>
